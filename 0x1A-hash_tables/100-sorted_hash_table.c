...
/**
 * make_shash_node - makes the node for the sorted hash table
 * @key: key for data
 ...
 * @table: the sorted the hash table
 * @node: a node to add
 *
 * Return: void
 */
 ...
 * @key: key to a data
 *
 * Return: a value associated with key, or NULL on failure
 */
...
/**
 * shash_table_print_rev - the prints a sorted hash table in reverse
